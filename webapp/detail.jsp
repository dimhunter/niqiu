...
<article class="blogs">
  ...
  <div class="index_about">
    ...
    <p class="box_c"><span class="d_time">发布时间：<fmt:formatDate pattern="yyyy-MM-dd" value="${blog.create_time}" /></span><span>编辑：申哥</span>
      <%--<span>互动QQ群：<a href="http://wp.qq.com/wpa/qunwpa?idkey=d4d4a26952d46d564ee5bf7782743a70d5a8c405f4f9a33a60b0eec380743c64">280998807</a></span></p>--%>
    <ul class="infos">
