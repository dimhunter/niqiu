  ...
  <div class="l_box f_l">
    ...
    <c:forEach items="${Blogs}" var="blg" >
      <div class="blogs">
        ...
        <ul>
          <h3><a href="${Context}showblog.do?b_id=${blg.id}" target="_blank">${blg.name}</a></h3>
          <p>${fn:substring(blg.content,0,85)}...</p>
          <p class="autor"><span class="lm f_l"><a href="/news/life/">${catmap[blg.category_id]}</a></span><span class="dtime f_l"><fmt:formatDate pattern="yyyy-MM-dd" value="${blg.create_time}" /></span><span class="viewnum f_r">浏览（<a href="/">459</a>）</span><span class="pingl f_r">评论（<a href="/">30</a>）</span></p>
        </ul>
      </div>
    </c:forEach>
    ...
    <div class="moreSelect" id="lp_right_select">
      ...
      <div class="ms-main" id="ms-main">
        ...
        <div  class="bd bd-news">
          <ul>
          <c:forEach items="${TopBlogs}" var="blg" >
            <li><a href="${Context}showblog.do?b_id=${blg.id}" target="_blank">${blg.name}</a></li>
          </c:forEach>
          </ul>
        </div>
        <div class="bd bd-news">
